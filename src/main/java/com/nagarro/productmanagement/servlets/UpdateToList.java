...
/**
 * Servlet implementation class UpdateToList.
 */
@WebServlet("/UpdateToList")
public class UpdateToList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int productID = (int) httpSesssion.getAttribute("PRODUCT_ID");
		ProductEntity object = hibernateSession.get(ProductEntity.class,productID);
		
		object.setTitle(request.getParameter("ProductName"));
		object.setSize(request.getParameter("ProductSize"));
		object.setQuantity(Integer.parseInt(request.getParameter("ProductQuantity")));
		String part = request.getParameter("ProductImage");
		if(!part.equals("")) {
			storeimg(part, object);			
		}
